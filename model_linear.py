...
class BertModel(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        self.linear0=nn.Linear(512*54, 512*27)
        self.linear0_=nn.Linear(512*27, 9984)
        self.linear1=nn.Linear(9984, 512*13)
        self.linear2=nn.Linear(512*13, 512*7)
        self.linear3=nn.Linear(512*7, 512*2)
        self.linear4=nn.Linear(512*2,512)
...
#torch.save(text_model.state_dict(), "/DATA/kartik_1901ce16/Review_Exhaustiveness/ckpt/baseline_linear.pt")
...
plt.savefig('/DATA/kartik_1901ce16/Review_Exhaustiveness/graphs_new/baseline_linear.png')
